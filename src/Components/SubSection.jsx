        ...
        <div className="flex">
            <div className="w-1/3 p-4 flex flex-col justify-between items-center">
                ...
                <div className="text-center">
                    <h1>Free island wide delivery</h1>
            ...
            <div className="w-1/3 p-4 flex flex-col justify-between items-center">
            <img src="https://splashythemes.com/opencart/OPC02/OPC020055/catalog/view/theme/stripchairlayout2/image/themeimage/service-3.svg" alt=""  width={60} height={60}/>
                <div className="text-center">
